...
heston_cal = HestonCalibrator(price_series=stock_data, cost_of_carry=r - q, mu_prior=0.001, sigma_sq_mu_prior=1.000,
                              delta_t=1.000, alpha_prior=2.000, beta_prior=0.005, p_prior=2.000, psi_prior=0.000,
                              theta_prior=0.000, sigma_sq_theta_prior=1.000, kappa_prior=0.000,
                              sigma_sq_kappa_prior=1.000, mu=0.050, kappa=0.500, theta=0.100, omega=0.100, psi=0.000)

start = time.time()
heston_cal.calibrate(n_mcmc_steps=n_mcmc_steps, burn_in=burn_in, rejection_rate=rejection_rate)
finish = time.time()
