...
cdef class BasicCalibrator:
    ...
    def __init__(self, price_series, cost_of_carry, mu_prior, sigma_sq_mu_prior, delta_t):
    ...
    cpdef double beta_star(self, double[:] V, double[:] Y, double[:] Z, double[:] B, double mu, double dt, double kappa,
        ...
        eps_S = self.get_eps_s(V, Y, Z, B, mu, dt)
        eps_V = self.get_eps_v(V, dt, kappa, theta)
    ...
    cpdef double state_space_target_dist_t_0(self, double V_proposed_or_current, double Y_t_plus_1, double V_t_plus_1,
        ...
        term_1 = self.state_space_target_dist_term_1(V_proposed_or_current, Y_t_plus_1, Z_t_plus_1, B_t_plus_1,
                                                    dt, mu, omega, psi)
        term_2 = self.state_space_target_dist_term_2(V_proposed_or_current, Y_t_plus_1, V_t_plus_1, Z_t_plus_1,
                                                    B_t_plus_1,
                                                    dt, mu, omega, psi, kappa, theta)
        term_3 = self.state_space_target_dist_term_3(V_proposed_or_current, V_t_plus_1, dt, omega, kappa, theta)
    ...
    cpdef double state_space_target_dist_t_1_to_T(self, double V_proposed_or_current, double Y_t, double Z_t, double B_t,
        ...
        term_2 = self.state_space_target_dist_term_2(V_proposed_or_current, Y_t_plus_1, V_t_plus_1, Z_t_plus_1,
                                                    ...
                                                    dt, mu, omega, psi, kappa, theta)
        term_3 = self.state_space_target_dist_term_3(V_proposed_or_current, V_t_plus_1, dt, omega, kappa, theta)
        term_4 = self.state_space_target_dist_term_4(V_proposed_or_current, Y_t, Z_t, B_t, V_t_minus_1,
                                                    dt, mu, omega, psi, kappa, theta)
        term_5 = self.state_space_target_dist_term_5(V_proposed_or_current, V_t_minus_1, dt, omega, kappa, theta)
